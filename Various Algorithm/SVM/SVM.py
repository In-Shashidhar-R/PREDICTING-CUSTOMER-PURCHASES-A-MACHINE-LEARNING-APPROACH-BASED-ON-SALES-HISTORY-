...
# Create an SVM model
model = SVC(kernel='linear')  # You can adjust the kernel and other parameters as needed
...
# Save the SVM model
filename = 'heart_disease_model_svm.sav'
...
loaded_model_svm = pickle.load(open('heart_disease_model_svm.sav', 'rb'))
